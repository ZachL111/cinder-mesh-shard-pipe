"""Regression checks for the cinder-mesh-shard-pipe casebook."""
...
from casebook.harness import assert_expected, cinder_mesh_shard_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_mesh_shard_pipe_summary(), assert_expected())
